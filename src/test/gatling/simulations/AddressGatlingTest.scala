...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "addressLine1":"SAMPLE_TEXT", "addressLine2":"SAMPLE_TEXT", "suburb":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "postcode":"SAMPLE_TEXT", "country":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
