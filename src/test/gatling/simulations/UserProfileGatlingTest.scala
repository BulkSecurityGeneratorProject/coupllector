...
class UserProfileGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the UserProfile entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "mobile":"SAMPLE_TEXT", "primaryEmailAddress":"SAMPLE_TEXT", "alternativeEmailAddress":"SAMPLE_TEXT", "rewardPoints":null}""")).asJSON
            .check(status.is(201))
